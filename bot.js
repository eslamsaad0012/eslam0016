...
client.on('ready', () => {
    ...
    client.user.setActivity("#help | LeaderBotSystem ",{type: 'Streaming'})
            ...
            message.channel.sendEmbed(embedx);
                                 ...
                                 client.on('message' , message => {
                                    ...
                                    client.on('message', message => { 
                                        ...
                                        .setFooter(`LeaderBotSystem`, 'https://cdn.discordapp.com/attachments/544986829355483147/544987382747758612/Leaders.jpg')                                 
